                    ...
                    <div  class="collapse show">
                        ...
                        <input type="hidden" name="page" value="input-peminjaman"/>
                            <div class="form-row">
                                ...
                                <span class="text"><i class="fas fa-search fa-sm"></i> Pilih Anggota</span>
                                </button>
                                </div>
                                <div class="col-sm-4">
                                <div class="form-group">
                                <div class="input-group">
                                <input type="text" class="form-control" id="nama_anggota" placeholder="Cari anggota">
                                <div class="input-group-append">
                                <button type="button" id="btn-cari" class="btn btn-dark">
                                <span class="text"><i class="fas fa-search fa-sm"></i> Cari Anggota</span>
                                </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <a href="peminjaman/simpan.php?kode_anggota=<?php echo $_GET['anggota'];?>"  id="tombol_simpan_peminjaman" class="btn btn-primary float-right"> Simpan</a>
                                </div>
