            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    ...
                    ?>
                        ...
                        <?php endif; ?>
                        <?php 
 if ($_SESSION['level']=='Anggota' || $_SESSION['level']=='anggota'):
?>
<div class="nav">
    <div class="sb-sidenav-menu-heading">Menu</div>
    <a class="nav-link" href="index.php?page=dashboard">
    ...
    <a class="nav-link" href="anggota/ulasan-buku/index.php">
       <div class="sb-nav-link-icon"><i class="fas fa-comment"></i></div>
       Ulasan Buku
    </a>
                    ...
                    if(isset($_GET['page'])){
                        ...
                        switch ($page) {
                            ...
                            case 'anggota':
                                ...
                                break;
                            case 'ulasan-buku':
                                include "anggota/ulasan-buku/index.php";
                                 break;
                            case 'karyawan':
                                include "karyawan/index.php";
                                break;
                            case 'ulasan-buku':
                                include "karyawan/ulasan-buku/index.php";
                                break;
                            case 'pustaka':
                            ...
                            case 'dashboard':
                                ...
                                break;
                            case 'login':
                                include "petugas//login.php";
                                break;
                            case 'petugas2':
                                include "petugas2/dashboard/index.blade.php";
                                break;
