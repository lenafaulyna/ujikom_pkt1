...
<main>
    <div class="container-fluid">
        ...
        <?php
            ...
            if ($_GET['hapus']=='berhasil'){
                ...
                echo"<div class='alert alert-danger'><strong>Gagal!</strong> Data Pustaka gagal dihapus!</div>";
            }    
            }
        ?>
      <div class="card mb-4">
    ...
    if (!$kon){
          die("Koneksi gagal:".mysqli_connect_error());
                                    ...
                                    $no++;
                                    ?>
                                    <option  value="<?php echo $data['nama_kategori_pustaka'];?>"><?php echo $data['nama_kategori_pustaka'];?></option>
                                    <?php
                                    endwhile;
                                    ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" multiple="multiple" name="penulis[]">
                                 ...
                                 if (!$kon){
                                    ...
                                    $no++;
                                    ?>
                                    <option  value="<?php echo $data['nama_penulis'];?>"><?php echo $data['nama_penulis'];?></option>
                                    <?php
                                    endwhile;
                                    ?>
                                </select>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" multiple="multiple" name="penerbit[]">
                                    ...
                                    $no++;
                                    ?>
                                    <option  value="<?php echo $data['nama_penerbit'];?>"><?php echo $data['nama_penerbit'];?></option>
                                    <?php
                                    endwhile;
                                    ?>
                                </select>
...
<script>
    ...
    var data = $('#form_pencarian_pustaka').serialize(); // Ambil data form sebagai URL-encoded string

    $.ajax({
        type    : 'POST',
        url     : 'petugas/pustaka/tampil-pustaka.php',
        data    : data, // Kirim data form
        cache   : false,
        success : function(data){
            $("#tampil_pustaka").html(data);
        }
